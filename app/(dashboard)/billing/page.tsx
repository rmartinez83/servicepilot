          ...
          {trialInfo.isTrial && !trialInfo.isExpired && (
            <div className="rounded-lg border border-amber-200 bg-amber-50/80 p-4">
              ...
              <p className="mt-1 text-sm text-amber-800">
                When your trial ends, you can start a paid subscription to keep using ServicePilot. You’ll get full access to scheduling, technicians, and invoicing. No charge until you choose a plan.
              </p>
            </div>
          )}
          ...
          {trialInfo.isTrial && trialInfo.isExpired && (
            <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Start a subscription to continue using ServicePilot.
              </p>
            </div>
          )}
